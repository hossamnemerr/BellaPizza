// Custom gradient button with optional icon and loading state
...
// Stateful button widget that animates on press
...
class _GradientButtonState extends State<GradientButton>
  ...
  Widget _content() {
    ...
    final ic = widget.icon != null
        ? IconTheme(
            data: IconThemeData(color: color, size: 20), child: widget.icon!)
        : null;
    if (widget.isLoading) {
