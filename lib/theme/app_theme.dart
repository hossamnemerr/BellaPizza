...
abstract final class AppColors {
  ...
  static const primary                = Color(0xFFFFB930); // Changed to Gold for more branding
  static const primaryDim             = Color(0xFFE0A020);
  static const primaryContainer       = Color(0xFF5C3A1A); // Warm brown
  static const onPrimary              = Color(0xFF2A1800); // Dark text on gold

  // Accent — Crimson Red
  static const crimson                = Color(0xFFFF3B2F); // vivid crimson
  static const onCrimson              = Color(0xFFFFFFFF);
...
abstract final class AppGradients {
  ...
  // Crimson CTA — for secondary actions
  static const crimsonCta = LinearGradient(
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
    colors: [AppColors.crimson, Color(0xFF8B1A12)],
  );
...
abstract final class AppShadows {
  ...
  static const primaryGlow = [BoxShadow(color: Color(0x55FFB930), blurRadius: 24, offset: Offset(0, 8))];
  static const crimsonGlow = [BoxShadow(color: Color(0x55FF3B2F), blurRadius: 24, offset: Offset(0, 8))];
...
abstract final class AppTheme {
  static ThemeData get dark {
    ...
    const cs = ColorScheme(
      ...
      tertiary: AppColors.crimson,         onTertiary: AppColors.onCrimson,
      tertiaryContainer: Color(0xFF8B1A12), onTertiaryContainer: Color(0xFFFFDAD5),
